...
public class ExerciseBung : AppCompatActivity(),TextToSpeech.OnInitListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        exerciseList=Constants1.defaultExerciseList()
        setupRestView()
        ...
        exerciseTimer = object:CountDownTimer(exerciseTimerDuration*1000,1000)
        {
            ...
            override fun onFinish() {
                if(currentExercisePosition<exerciseList?.size!!-1){
                    ...
                    finish()
                    val intent = Intent(this@ExerciseBung,FinishAtcivity::class.java)
